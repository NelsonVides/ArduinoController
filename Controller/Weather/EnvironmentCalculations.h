...
namespace Weather {
    namespace EnvironmentCalculations {
        ...
        enum class AltitudeUnit {
            AltitudeUnit_Meters, AltitudeUnit_Feet
        };
        ...
        float Altitude(float pressure,
                       AltitudeUnit altUnit = AltitudeUnit::AltitudeUnit_Meters,
        ...
        int HeatIndex(float temperature,
                      float humidity,
                      TempUnit tempUnit = TempUnit::TempUnit_Celsius);
        ...
        float AbsoluteHumidity(float temperature,
                               float humidity,
                               TempUnit tempUnit);
